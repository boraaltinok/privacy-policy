...
This privacy policy applies to the AI Math Solver app (hereby referred to as "Application") for mobile devices that was created by Bora Altınok (hereby referred to as "Service Provider") as a Commercial service. This service is intended for use "AS IS".
...
For a better experience, while using the Application, the Service Provider may require you to provide us with certain personally identifiable information, including but not limited to userId,user questions. The information that the Service Provider request will be retained by them and used as described in this privacy policy.
...
This privacy policy is effective as of 2024-07-25
