...
- Upload inappropriate, illegal, or copyrighted content
...
- We strive to provide accurate card identification and pricing information
- Card identification uses AI/ML technology and may occasionally produce incorrect results
- Pricing data is sourced from third-party market data providers and may not reflect real-time market conditions
- We do not guarantee 100% accuracy for all cards or pricing information

### 5.2 Pricing Disclaimers
- Pricing information is for reference only and does not constitute financial advice
- Actual card values may vary based on condition, market demand, and other factors
- We are not responsible for financial decisions made based on pricing information provided
...
- Card images are processed using AI services to provide identification results
...
### 6.2 Collection Data
- Your card collection data is stored locally on your device
- Collection data is not transmitted to external servers
- You are responsible for backing up your collection data
- Uninstalling the app will permanently delete local collection data
...
- **Firebase** (Google) for analytics, authentication, and cloud functions
- **OpenRouter** for AI-powered card identification
- **RevenueCat** for subscription management
- **Amplitude** for advanced analytics
- **Pricing APIs** from TCGPlayer, Cardmarket, and eBay

### 7.2 Third-Party Terms
Your use of the App is also subject to the terms and conditions of these third-party services. We are not responsible for changes to or discontinuation of third-party services.
...
- Card identification technology may occasionally produce incorrect results
- Pricing data may be delayed, incomplete, or inaccurate
- We are not responsible for decisions made based on app information
- Users should verify card details and pricing through additional sources
...
- We are not liable for losses related to card transactions or investments
...
### 9.2 Pokémon Trademarks
- All Pokémon-related trademarks, characters, names, and imagery are owned by The Pokémon Company International, Nintendo, Creatures, and Game Freak
- This app is an unofficial reference tool and is not endorsed by or affiliated with these companies
- Use of Pokémon-related content is for identification purposes only under fair use principles

### 9.3 User Content
By using the App, you grant us a non-exclusive license to process images you upload for the purpose of providing identification services.
