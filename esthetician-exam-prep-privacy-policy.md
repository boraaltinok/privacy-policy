...
This privacy policy applies to the Esthetician Exam Prep for 2024 app (hereby referred to as "Application") for mobile devices that was created by Bora Atınok (hereby referred to as "Service Provider") as a Commercial service. This service is intended for use "AS IS".
