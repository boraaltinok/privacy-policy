...
By downloading or using **Light Meter** ("Application"), provided by NEXTLINE YAZILIM LİMİTED ŞİRKETİ ("Service Provider", "we", or "us"), you agree to be bound by these Terms & Conditions. Please read them carefully.
...
- You may use the Application in personal, educational, and professional environments (e.g., home, office, studios, greenhouses).
...
- Certain features of the Application — including subscription management, crash reporting, and analytics — require an active internet connection. Core light measurement functionality works fully offline.
...
- The light level measurements provided by the Application are **approximate** and intended for informational and educational purposes only.
- Measurement accuracy depends on your device's camera hardware and environmental conditions. The Application is **not** a certified lux meter or professional measurement instrument and should not be used as a substitute for professional-grade measurement equipment.
- The Application offers two measurement modes — Quick Check and White Paper — both of which provide approximations and are not calibrated to professional standards.
...
## 9. Governing Law
These Terms & Conditions are governed by the laws of the Republic of Turkey without regard to its conflict of laws principles.
