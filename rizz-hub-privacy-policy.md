...
This privacy policy applies to the Rizz Hub app (hereby referred to as "Application") for mobile devices that was created by Bora Altınok (hereby referred to as "Service Provider") as a Commercial service. This service is intended for use "AS IS".
